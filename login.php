...
<!-- //web-fonts -->
	...
	<div class="agileits-banner jarallax">
		...
		<div class="container"> 
		<h3 class="w3ls_head" style="color:white;">User Login</h3>
			...
			<div class="contact-info">
				<div class="col-md-4 contact-grids">
					...
					<div class="contact-form">
						...
						<center>	<input type="email" placeholder="Email" name="b" required="" style="margin-left:-300px;"><br></center><br>
						<center>	<input type ="text" placeholder="password" name="c" required="" style="margin-left:80px;"><br>
